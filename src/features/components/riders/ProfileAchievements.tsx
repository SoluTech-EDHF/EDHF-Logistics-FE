...
const ProfileAchievements = ({ isLoading }: { isLoading: boolean }) => {
  return (
    <div className="mb-7.5 w-full min-h-fit bg-white shadow-md rounded-md flex flex-col justify-center gap-7 pl-4.5 pr-7.25 py-11.5">
      <h3 className="text-2xl font-bold">Achievements</h3>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 max-sm:grid-rows-2 min-h-fit">
        {isLoading
